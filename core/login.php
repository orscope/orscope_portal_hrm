            ...
            <div class="pt-10 pb-6 pl-11 pr-12 bg-black-2 h-100 d-flex flex-column dark-mode-texts">
                <div class="pb-9">
                    <h3 class="font-size-7 text-white line-height-reset pb-4 line-height-1p4">
                        <?=empty($companyName) || $companyName === 'Sample Company Pvt Ltd' ? 'ORSCOPE Login' : $companyName?>
                    </h3>
                    <p class="mb-0 font-size-4 text-white">Log in to continue to your ORSCOPE Account</p>
